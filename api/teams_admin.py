...
def build_admin_placeholder(
    ...
    *,
    ...
    return {
        ...
        "policy_file_name": payload.get("policy_file_name") or "",
        "policy_version": payload.get("policy_version") or "",
        "policy_effective_date": payload.get("policy_effective_date") or "",
        "policy_uploaded_by": payload.get("policy_uploaded_by") or "",
